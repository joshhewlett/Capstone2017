...
public class ModalMenuManager : MonoBehaviour {
    ...
    public GameObject arrowNavigations;
    ...
    void Start () {
        ...
        backButton.SetActive(debugPoly);
        GooglePoly.SetActive(debugPoly);
        ...
        switch (QuickMenuPanel) {
            case PanelModes.Presentations:
                ...
                foreach (Transform thumbnail in thumbnails.transform) {
                    thumbnail.GetComponent<ThumbnailSelection>().PolyMode = false;
            ...
            case PanelModes.Objects:
                ...
                foreach (Transform thumbnail in thumbnails.transform) {
                    ...
                    thumbnail.GetChild(2).gameObject.SetActive(false);
                    thumbnail.gameObject.GetComponent<ThumbnailSelection>().outlineSelection = false;
                }
                foreach (Transform arrow in arrowNavigations.transform) {
                    arrow.GetComponent<ArrowNavigation>().PolyMode = false;
                }
                break;
            case PanelModes.Poly:
                GooglePoly.SetActive(false);
                ...
                foreach (Transform thumbnail in thumbnails.transform) {
                    ...
                    thumbnail.GetComponent<ThumbnailSelection>().PolyMode = true;
                    thumbnail.GetChild(0).gameObject.SetActive(false);
                    thumbnail.GetChild(2).gameObject.SetActive(true);
                }
                foreach (Transform arrow in arrowNavigations.transform) {
                    arrow.GetComponent<ArrowNavigation>().PolyMode = true;
                }
